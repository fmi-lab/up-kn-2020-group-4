...
int getSumOfAllEvenNumbersUnderMainDiagonal(int arr[MAX_ARR_SIZE][MAX_ARR_SIZE], size_t size) {
	int sum = 0;
	for (int i = 0; i < size; i++) {
		for (int j = 0; j < size; j++) {
...
int main() {
	...
	int sumOfAllEvenNumbersUnderMainDiagonal = getSumOfAllEvenNumbersUnderMainDiagonal(arr, size);
	cout << "Sum Of All Even Numbers Under Main Diagonal = " << sumOfAllEvenNumbersUnderMainDiagonal << endl;
